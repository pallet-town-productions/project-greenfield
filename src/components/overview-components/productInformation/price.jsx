...
const Price = function ({ productData, style, currentStyleIndex }) {
  let price = Number(style.results[currentStyleIndex].original_price) || Number(productData.default_price);
  let salePrice = Number(style.results[currentStyleIndex].sale_price); // default 0
